...
<body>
	...
	<a href="./RequestWebInfo.jsp?eng=Hello&han=안녕">GET 방식 전송</a> <%-- 1. GET 방식으로 요청 --%>
	</br>
	<form method="post" action="RequestWebInfo.jsp"> <%-- 2. POST 방식으로 요청 --%>
	...
	<a href="RequestHeader.jsp">요청 헤더 정보 읽기</a> <%-- 4. HTTP 요청 헤더 읽기 --%>
</body>
</html>